  ...
  return (openBlock(), createBlock("div", _hoisted_1$4, [
    createVNode("div", _hoisted_2$4, [
      renderSlot(_ctx.$slots, "icon", {}, () => [
        (openBlock(), createBlock(resolveDynamicComponent(_ctx.iconElement), { class: _ctx.iconElement }, null, 8 /* PROPS */, ["class"]))
      ])
    ]),
    (_ctx.title || _ctx.$slots.title)
      ? (openBlock(), createBlock("div", _hoisted_3, [
          renderSlot(_ctx.$slots, "title", {}, () => [
            createVNode("p", null, toDisplayString(_ctx.title), 1 /* TEXT */)
          ])
        ]))
